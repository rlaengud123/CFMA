...
def main():
    ...
    dataset_path= r'data\mydata\comb.csv'
    path = r'chkpt\2021-02-17_21-08-56_dfm'
    df = pd.read_csv(r'data\mydata\comb.csv')
    batch_size = 8192
    ...
    model = torch.load(os.path.join(path, f'{model_name}_best.pt'))
